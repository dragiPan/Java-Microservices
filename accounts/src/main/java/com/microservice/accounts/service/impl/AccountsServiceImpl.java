...
public class AccountsServiceImpl implements IAccountsService {
     ...
     *
     * @param customer The customer whose account is to be created.
     * @return A new account with a randomly generated account number, account type as SAVINGS and branch address as the DEFAULT_ADDRESS.
     */
